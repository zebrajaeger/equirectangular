package de.zebrajaeger.equirectangular.core.psdimage.linereader;
...
public abstract class LineReader {
    ...
    private FileImageInputStream inputStream;

    public LineReader(FileImageInputStream inputStream, int lineSize) {
